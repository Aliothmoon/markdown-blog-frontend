          ...
          ">
                    ...
                    <el-collapse :accordion=true style="margin: 20px">
                        <el-collapse-item title="Consistency" name="1" v-if="editable">
                            <div>
                                <q-btn flat class="fit" color="purple"
                                       @click="router.push({name:'editor'});drawer = false">
                                    <span>Edit</span>
                                </q-btn>
                            </div>
                        </el-collapse-item>
                        ...
                        <el-collapse-item title="Efficiency" name="3" v-if="!editable">
                            ...
                            <n-space vertical style="margin-bottom: 20px">
                                <n-input type="text" autosize placeholder="None" v-model:value=psw
          ...
          justify-content: space-between">
                ...
                <el-main style="padding: 15px 20px 10px">
                    ...
                    >
                        ...
                        <el-footer height="30px" hidden
                                   style="background-color:rgba(29, 38, 49,0.5);margin: 10px 10px 0 ;">
...
import {getSearchResult} from '@/api/article/index.js'
import {QScrollArea} from "quasar";
import {NInput, NSpace} from "naive-ui";
import LocalStorage from '@/utils/cache.js'
import {Auth, GetAuth} from '@/api/article/auth.js'
